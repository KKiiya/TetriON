...
/// <summary>
/// 7+1 bag system - Standard 7-bag plus one random duplicate piece
/// Creates 8-piece bags with slight bias
/// </summary>
public class SevenPlusOneBagGenerator : IBagGenerator {
    private readonly Random _random;
    private Queue<Tetromino> _currentBag;
    private Queue<Tetromino> _nextBag;

    public SevenPlusOneBagGenerator(int? seed = null) {
