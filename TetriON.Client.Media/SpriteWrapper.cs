...
public class SpriteWrapper : TextureWrapper {
    ...
    public SpriteWrapper(IController controller, TextureWrapper spriteSheet, Dictionary<int, (Vector2 pointA, Vector2 pointB)> frames, float frameDuration, bool isLooping = true)
        : base(controller, spriteSheet.Texture) {
    ...
    /// <param name="frameDuration">Duration of each frame in seconds</param>
    /// <param name="isLooping">Whether the animation should loop</param>
    public SpriteWrapper(IController controller, TextureWrapper spriteSheet, Dictionary<int, Rectangle> frames, float frameDuration, bool isLooping = true)
        : base(controller, spriteSheet.Texture) {
    ...
    /// <param name="frameDuration">Duration of each frame in seconds</param>
    /// <param name="isLooping">Whether the animation should loop</param>
    public SpriteWrapper(IController controller, TextureWrapper spriteSheet, int frameWidth, int frameHeight, int totalFrames, int framesPerRow, float frameDuration, bool isLooping = true)
        : base(controller, spriteSheet.Texture) {
    ...
    /// </summary>
    public ITexture SpriteSheet => this;
