...
partial class MainMenuRuntime : BindableGue {
    ...
    public MainMenuRuntime(IController controller) {
    ...
    private void ApplyDefaultVariables() {
        ...
        ButtonContainer.StackSpacing = 20f;
        ...
        ButtonContainer.XOrigin = HorizontalAlignment.Left;
        ButtonContainer.XUnits = GeneralUnitType.PixelsFromSmall;
        ButtonContainer.Y = 25f;
        ButtonContainer.YUnits = GeneralUnitType.Percentage;

        GreenButtonInstance1.X = 0f;
        GreenButtonInstance1.Y = 0f;
