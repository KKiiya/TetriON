...
using TetriON.Shared.UI.Menus.MainMenu;
using TetriON.Shared.Rendering;
using TetriON.Shared.UI.Menus;
using TetriON.Shared.UI.Modals;
using TetriON.Shared.Core;

namespace TetriON.Shared.Session;
...
public class GameSession
{
    ...
    public GameSession(TetriONGame game)
    {
    ...
    public TetriONGame GetGameInstance()
    {
        return _game;
    }
