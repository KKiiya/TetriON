...
namespace TetriON.Shared.Content;
...
public class AnimatedTextureWrapper : InterfaceTextureWrapper
{
    ...
    public new void Draw(Vector2 screenPos, Color color, Vector2 scale)
    {
        ...
        if (_frames.TryGetValue(_currentFrame, out Rectangle sourceRect))
        {
            ...
            TetriONGame.Instance.SpriteBatch.Draw(GetTexture(), finalPosition, sourceRect, color, 0f, Vector2.Zero, scale, SpriteEffects.None, 0f);
        }
    }
    ...
    public void Draw()
    {
        ...
        if (_frames.TryGetValue(_currentFrame, out Rectangle sourceRect))
        {
            ...
            var renderRes = TetriONGame.Instance.GetRenderResolution();
            ...
            // Draw current frame with source rectangle
            TetriONGame.Instance.SpriteBatch.Draw(GetTexture(), finalPosition, sourceRect, Color.White, 0f, Vector2.Zero, scale, SpriteEffects.None, 0f);
        }
    }
    ...
    public void Draw(float transparency)
    {
        ...
        if (_frames.TryGetValue(_currentFrame, out Rectangle sourceRect))
        {
            ...
            TetriONGame.Instance.SpriteBatch.Draw(GetTexture(), finalPosition, sourceRect, Color.White * Math.Clamp(transparency, 0f, 1f), 0f, Vector2.Zero, scale, SpriteEffects.None, 0f);
        }
    }
