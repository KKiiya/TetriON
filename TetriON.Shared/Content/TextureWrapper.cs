...
public class TextureWrapper : IDisposable
{
    ...
    private static readonly SpriteBatch Sb = TetriONGame.Instance.SpriteBatch;
    ...
    public TextureWrapper(string path)
    {
        ...
        try
        {
            ...
            var skinManager = TetriONGame.Instance.SkinManager;
            ...
            {
                _texture = TetriONGame.Instance.Content.Load<Texture2D>(path);
        ...
        catch (Exception e)
        {
            try
            {
                _texture = TetriONGame.Instance.Content.Load<Texture2D>("missing_texture");
