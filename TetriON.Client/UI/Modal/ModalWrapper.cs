...
using static TetriON.Client.Input.InputManager;
...
public class ModalWrapper : IDisposable {
    ...
    public ModalWrapper(ClientController controller, ModalType type = ModalType.Default) {
    ...
    public void Draw() {
        ...
        try {
            var spriteBatch = _controller.Game.GraphicsDevice;
            var renderRes = _controller.Game.GetRenderResolution();
