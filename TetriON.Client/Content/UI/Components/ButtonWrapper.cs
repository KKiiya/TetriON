...
public class ButtonWrapper : MenuComponent {
    ...
    public ButtonWrapper(ClientController controller, MenuWrapper menu, Point normalizedPosition, string id = "", Dictionary<ButtonState, TextureWrapper> textures = null) : base(controller) {
        _id = id ?? string.Empty;
    ...
    public ButtonWrapper(ClientController controller, MenuWrapper menu, TextureWrapper texture, string id = "")
        : this(controller, menu, new Point(0, 0), id, new Dictionary<ButtonState, TextureWrapper> { { ButtonState.Normal, texture } }) {
        Initialize();
    }
