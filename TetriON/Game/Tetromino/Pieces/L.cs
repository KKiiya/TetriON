...
public class L : Tetromino {
    ...
    private readonly byte _id = 0x06;
    ...
    private bool IsSpin(Grid grid, Point pivot) {
        // L-Spin detection based on center pivot point
        // The pivot for L-piece is at position [1, 1] in the 3x3 matrix
        ...
        // An L-Spin requires at least 3 of the 4 corners to be occupied
